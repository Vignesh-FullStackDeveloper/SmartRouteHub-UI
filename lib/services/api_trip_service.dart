...
class ApiTripService {
  ...
  Future<List<Trip>> getActiveTrips() async {
    try {
      ...
      if (response is Map<String, dynamic> && response.containsKey('data')) {
        ...
        if (data is List) {
          return data.map((e) => _parseTrip(e as Map<String, dynamic>)).toList();
        }
      }
  ...
  Future<Trip> getTripById(String id) async {
    try {
      ...
      // Handle new response format: { success: true, data: {...}, message: "..." }
      if (response is Map<String, dynamic> && response.containsKey('data')) {
        return _parseTrip(response['data'] as Map<String, dynamic>);
      }
      
      // Handle old response format: direct object
      return _parseTrip(response as Map<String, dynamic>);
    } catch (e) {
  ...
  Future<Trip> endTrip(String tripId) async {
    try {
      final response = await _apiClient.post('/trips/$tripId/end', body: {'data': {}});
